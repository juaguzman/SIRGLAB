...
<html>
    ...
    <body>
        ...
        <form action="<?php echo esc_url($_SERVER['PHP_SELF']); ?>"  method="post" name="registration_form">
            Cedula:  <input type="number" name="cedu" id="cedu" required/><br>
            Nombre de usuario: <input type='text'name='username' id='username' required="" /><br>
            Correo electrónico: <input type="text" name="email" id="email" required /><br>
            Contraseña: <input type="password" name="password" id="password" required/><br>
            Confirmar contraseña: <input type="password" name="confirmpwd" id="confirmpwd" required/><br>
